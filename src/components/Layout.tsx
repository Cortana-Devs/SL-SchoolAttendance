  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="sticky top-0 z-50 bg-white shadow-sm">
        ...
        {/* Mobile menu */}
        <div className={`md:hidden border-t border-gray-200 ${isMenuOpen ? 'block' : 'hidden'}`}>
          <div className="space-y-1 px-4 py-3">
            {menuItems.map((item) => (
              <Link
                ...
                className="flex items-center px-3 py-2 text-base font-medium text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded-md transition-colors"
              >
                <item.icon className="h-5 w-5 mr-2" />
                {item.name}
              </Link>
